...
#Scale is 1-4, 1 being not safe at all, 4 being safe
...
#Exercise Data
#Shows number of days a week person performs certain type of exercise
...
#1 indicates person had difficulty handling thing, 0 indicates no
...
#Year in school
#Dummy variable for each year, base level indicates person is 5th year or graduate
...
#Relationship
#1 indicates person is in a relationship, 0 indicates no
...
#GPA
#Dummy variables for each letter grade, base level is a C
...
#Disabilities
#1 indicates person has specific disability, 0 indicates person does not
...
#Mood and feelings data
#1 indicates person felt specific feeling asked, 0 indicates no
...
UVA_data <- UVA_data[-c(30:33)]

UVA_data <- na.omit(UVA_data)

#write.csv(UVA_data, "UVA Clean Final.csv")
